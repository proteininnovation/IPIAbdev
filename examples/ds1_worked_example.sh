...
# DS1 subset shipped in tests/ and the DELPHI command-line interface.
#
...
DB=tests/DS1_psr_500.xlsx     # public DS1 subset (committed); swap for tests/DS1.xlsx after step 1
TARGET=psr_filter

# 1. (optional) download the full public DS1 dataset (writes tests/DS1.xlsx and a subset)
