...
| Main Figure 3 | `figures/code/fig3.py` | sequence-free IPI validation scores in Supplementary Table 4, 10-fold CV table, replicated learning curves | `figures/output/Figure3.*` | Script, render and sequence-free source tables public |
...
| Extended Data Figure 3 | `figures/code/ed3.py` | canonical 25-model IPI source workbook plus the DS1 sheet in Supplementary Table 4 | `figures/output/ED_Fig3.*` | Script, render and sequence-free source workbooks public |
...
| Extended Data Figure 8 | `figures/code/ed7.py` | IPI PSR/SEC tables and two one-hot checkpoints | not committed publicly because the final loop-mutagenesis panel displays the selected WT loop residues | Generator public; render, data and checkpoints local only |
